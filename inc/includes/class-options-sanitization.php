...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => esc_html__( 'No Repeat', 'dewi2' ),
		'repeat-x'  => esc_html__( 'Repeat Horizontally', 'dewi2' ),
		'repeat-y'  => esc_html__( 'Repeat Vertically', 'dewi2' ),
		'repeat'    => esc_html__( 'Repeat All', 'dewi2' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => esc_html__( 'Top Left', 'dewi2' ),
		'top center'    => esc_html__( 'Top Center', 'dewi2' ),
		'top right'     => esc_html__( 'Top Right', 'dewi2' ),
		'center left'   => esc_html__( 'Middle Left', 'dewi2' ),
		'center center' => esc_html__( 'Middle Center', 'dewi2' ),
		'center right'  => esc_html__( 'Middle Right', 'dewi2' ),
		'bottom left'   => esc_html__( 'Bottom Left', 'dewi2' ),
		'bottom center' => esc_html__( 'Bottom Center', 'dewi2' ),
		'bottom right'  => esc_html__( 'Bottom Right', 'dewi2')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => esc_html__( 'Scroll Normally', 'dewi2' ),
		'fixed'  => esc_html__( 'Fixed in Place', 'dewi2')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => esc_html__( 'Normal', 'dewi2' ),
		'italic'      => esc_html__( 'Italic', 'dewi2' ),
		'bold'        => esc_html__( 'Bold', 'dewi2' ),
		'bold italic' => esc_html__( 'Bold Italic', 'dewi2' )
		);
